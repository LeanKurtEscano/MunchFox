...
const Footer = () => {
  return (
    <footer className="bg-customOrange">
        ...
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <ul className="text-white font-medium">
              ...
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">Brand Center</a>
              </li>
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">Blog</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-white font-medium">
              ...
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">Facebook</a>
              </li>
              <li className="mb-4">
          ...
          <div>
            ...
            <ul className="text-white font-medium">
              ...
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">Licensing</a>
              </li>
              <li className="mb-4">
          ...
          <div>
            ...
            <ul className="text-white font-medium">
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">iOS</a>
              </li>
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">Android</a>
              </li>
              <li className="mb-4">
                <a href="#" className="hover:text-white hover:underline">Windows</a>
              </li>
            </ul>
          </div>
        </div>
